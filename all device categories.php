    ...
    <section id="services">
        ...
        <div class="container">
			...
			?>
					...
					<div class="col-lg-3 col-md-6 text-center"><a href="Device Category.php?category=<?echo $sendName;?>">
						<div class="service-box">
							<i class="fa fa-4x text-primary sr-icons"><img class="deviceCategories" src="img/allDeviceCategories/<?echo $icon ?>.png"/></i>
							<h3><?echo $name;?></h3>
